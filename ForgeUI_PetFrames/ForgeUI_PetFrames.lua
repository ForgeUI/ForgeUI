...
function ForgeUI_PetFrames:OnPetSpawned()	
	ChatSystemLib.PostOnChannel(2, "ForgeUI_PetFrames:OnPetSpawned()");

	self.wndPetControl:Show(true, true)
end

function ForgeUI_PetFrames:OnPetDespawned()
	ChatSystemLib.PostOnChannel(2, "ForgeUI_PetFrames:OnPetDespawned()");
...
function ForgeUI_PetFrames:OnMount()
	ChatSystemLib.PostOnChannel(2, "ForgeUI_PetFrames:OnMount()");

	petTimer = ApolloTimer.Create(0.1, false, "MountPetTimer", self)
end

function ForgeUI_PetFrames:MountPetTimer()
	ChatSystemLib.PostOnChannel(2, "ForgeUI_PetFrames:MountPetTimer()");
